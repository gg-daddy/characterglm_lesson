...
st.sidebar.selectbox("图片风格", ["二次元", "油画", "水墨画", "素描", "手绘",
                     "文艺复兴", "超现实主义", "魔幻"], index=0, key="picture_style")
...
def draw_new_image():
    ...
    image_prompt = f'请根据下面的描述生成一张【{st.session_state["picture_style"]}】风格的图片。 图片内容描述：\n{image_prompt.strip()}'
